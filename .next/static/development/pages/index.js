...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "aOrAn", function () {
      if (!_this.state.audience.length) {
        return "a";
      } else {
        return /[aeiou]/.test(_this.state.audience.toLowerCase().charAt(0)) ? "an" : "a";
      }
    });
