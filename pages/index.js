        ...
        <div>
          <AppContainer>
            <div className="modal">
              ...
              <p className="font-sml font-weight-bold">That is a <span className="font-color-purple"> fantastic</span> mystery. It’s been submitted to global mystery headquarters.</p>
              <div className="button margin-top-med background-color-twitter-blue">
                ...
                <p className="margin-left-sml margin-right-sml">Share Your Mystery With The Twitterverse</p>
              </div>
            </div>
          </AppContainer>
        </div>
